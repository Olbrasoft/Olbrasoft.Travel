...
{
    internal class PointsOfInterestCoordinatesImporter : Importer<PointOfInterestCoordinates>
    {
        public PointsOfInterestCoordinatesImporter(ImportOption option) : base(option)
        {
        }
